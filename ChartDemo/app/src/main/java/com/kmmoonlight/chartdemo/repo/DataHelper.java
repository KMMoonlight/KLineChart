...
public class DataHelper {
     ...
     * @param dataList
     */
    static void calculateRSI(List<KLineRepo> dataList) {
        Float rsi;
        float rsiABSEma = 0;
        float rsiMaxEma = 0;
        for (int i = 0; i < dataList.size(); i++) {
            KLineRepo point = dataList.get(i);
     ...
     * @param dataList
     */
    static void calculateKDJ(List<KLineRepo> dataList) {
        float k = 0;
        float d = 0;
        for (int i = 0; i < dataList.size(); i++) {
            KLineRepo point = dataList.get(i);
     ...
     * @param dataList
     */
    static void calculateWR(List<KLineRepo> dataList) {
        Float r;
        for (int i = 0; i < dataList.size(); i++) {
            KLineRepo point = dataList.get(i);
            int startIndex = i - 14;
     ...
     * @param dataList
     */
    static void calculateMACD(List<KLineRepo> dataList) {
        float ema12 = 0;
        float ema26 = 0;
        float dif = 0;
        float dea = 0;
     ...
     * @param dataList
     */
    static void calculateBOLL(List<KLineRepo> dataList) {
        for (int i = 0; i < dataList.size(); i++) {
            KLineRepo point = dataList.get(i);
            if (i < 19) {
                point.mb = 0;
     ...
     * @param dataList
     */
    static void calculateMA(List<KLineRepo> dataList) {
        float ma5 = 0;
        float ma10 = 0;
        float ma20 = 0;
        float ma30 = 0;
     ...
     * @param dataList
     */
    public static void calculate(List<KLineRepo> dataList) {
    ...
    private static void calculateVolumeMA(List<KLineRepo> entries) {
        float volumeMa5 = 0;
        float volumeMa10 = 0;

        for (int i = 0; i < entries.size(); i++) {
            KLineRepo entry = entries.get(i);
