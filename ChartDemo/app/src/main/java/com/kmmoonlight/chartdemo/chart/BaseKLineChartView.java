...
import com.kmmoonlight.chartdemo.R;
...
import com.kmmoonlight.chartdemo.draw.MainDraw;
import com.kmmoonlight.chartdemo.draw.Status;
import com.kmmoonlight.chartdemo.formatter.TimeFormatter;
import com.kmmoonlight.chartdemo.formatter.ValueFormatter;
import com.kmmoonlight.chartdemo.repo.IKLine;
import com.kmmoonlight.chartdemo.utils.ViewUtil;
...
public abstract class BaseKLineChartView extends ScrollAndScaleView {
    ...
    public void setAdapter(IAdapter adapter) {
        if (mAdapter != null && mDataSetObserver != null) {
            mAdapter.removeDataSetObserver(mDataSetObserver);
        }
        mAdapter = adapter;
        if (mAdapter != null) {
